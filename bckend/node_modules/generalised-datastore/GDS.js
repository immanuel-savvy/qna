  ...
  function GDS(ds_name, base_path) {
    ...
    _defineProperty(
      ...
      function (sync_handler) {
        ...
        if (!existsSync(_this.folders_path))
          mkdirSync(_this.folders_path, {
            recursive: true,
          });
        ...
        if (!existsSync(_this.ds_config_path)) {
          ...
          _this.config = JSON.parse(
            readFileSync(_this.ds_config_path, {
              encoding: "utf8",
            })
          );
    ...
    _defineProperty(
      _assertThisInitialized(_this),
      "folder",
      function (folder_name, subfolder, joins) {
        if (!_this.synced) throw new Error("Sync GDS first!");
        var folder = new _Folder["default"](
          folder_name,
          _assertThisInitialized(_this),
          subfolder
        ).create(joins);
    ...
    _defineProperty(
      ...
      function (folder_name) {
        return (
          folder_name.split &&
          _this.folders.find(function (folder) {
            return (
    ...
    _this._path =
      base_path || "".concat(process.env["HOME"], "/.GDS/").concat(ds_name);
