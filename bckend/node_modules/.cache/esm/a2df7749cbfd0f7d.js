let DISCUSSIONS,FORUMS,QUESTIONS,REPLIES;_cbf‍.x([["comments",()=>comments],["new_comment",()=>new_comment],["new_reply",()=>new_reply],["replies",()=>replies]]);_cbf‍.w("../ds/conn",[["DISCUSSIONS",["DISCUSSIONS"],function(v){DISCUSSIONS=v}],["FORUMS",["FORUMS"],function(v){FORUMS=v}],["QUESTIONS",["QUESTIONS"],function(v){QUESTIONS=v}],["REPLIES",["REPLIES"],function(v){REPLIES=v}]]);
