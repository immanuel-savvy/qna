...
const gen_random_int = (max_int, min_int = 0) => min_int + Math.floor(Math.random() * max_int);
...
export { _id, gen_random_int, get_timestamp_from_id, copy_object, valid_id, generate_random_string, month_index, shuffle_array };